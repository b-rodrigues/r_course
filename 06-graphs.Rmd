...
To create the pie chart, it is enough to add the option `coord_polar()` at the end of the code: this
is because a pie chart can be seen as a barplot living in a world with polar coordinates:
