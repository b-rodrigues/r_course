...
and how it can work together with `ggplot2` to generate many plots.
...
could use the search and replace function of RStudio, true, but something search and replace can
...
This creates a tibble with two columns, `division` and `data`, where for each individual (or
